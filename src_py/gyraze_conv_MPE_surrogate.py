...
model.load_state_dict(torch.load(os.path.join(_MODEL_DIR, "nn_model_conv_MPE.pth"), map_location='cpu'))
model.eval()

# Load normalization parameters
norms = np.load(os.path.join(_MODEL_DIR, "normalization_conv_MPE.npz"))
